...
public:
    ...
    /// Call collision detection routine.
...
signals:
    /// This signal is emmited when player position or direction angles changes.
    void playerPosChanged();

    /// This signal is emmited after initializing openGL context.
    void glInitialized();

    /// This signal is emmited after collision detection routine.
...
private:
    ...
    /// Camera speed of rotation.
    float cameraRadSpeed;

    /// Camera speed.
    float cameraVecSpeed;

    /// Character speed of rotation.
    float objectRadSpeed;
